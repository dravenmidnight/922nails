<!-- 
	TODO: 
	1. Refactor: create partial for assets calls & append to body. 
-->
...
.img-1 {
	background-image: url(../assets/img/gallery/1513654680_31a.jpg);
}
.img-2 {
	background-image: url(../assets/img/gallery/1513654680_24a.jpg);
}
.img-3 {
	background-image: url(../assets/img/gallery/1513654680_23a.jpg);
}
.img-4 {
	background-image: url(../assets/img/gallery/1513654680_22a.jpg);
}
.img-5 {
	background-image: url(../assets/img/gallery/1513654680_21a.jpg);
}
.img-6 {
	background-image: url(../assets/img/gallery/1513654680_17a.jpg);
}
.img-7 {
	background-image: url(../assets/img/gallery/1513654680_16a.jpg);
}
.img-8 {
	background-image: url(../assets/img/gallery/1513654680_15a.jpg);
}
.img-9 {
	background-image: url(../assets/img/gallery/1513654680_14a.jpg);
}

</style>
<section class="container mb-30">
	<div class="col-sm-6 col-md-4 col-xs-6 p-0">
		<a href="<?php echo $aPATH ?>img/gallery/1513654680_31a.jpg" class="gallery-item gallery-item-popup thumbnail" data-group="gallery-1" title="Gallery" itemprop="url">
